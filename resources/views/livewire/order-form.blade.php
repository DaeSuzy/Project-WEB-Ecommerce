<div>
    <div class="flex w-[260px] h-[160px] shrink-0 overflow-hidden mx-auto mb-10">
                ...
                src="{{ Storage::url($dompet->photos()->latest()->first()->photo) }}" 
                ...
                <div class="flex flex-col rounded-[20px] p-4 mx-4 pb-5 gap-5 bg-white">
                    <div id="info" class="flex items-center justify-between">
                        <div class="flex flex-col">
                            ...
                            <p class="font-semibold text-lg leading-[27px]">
                                Rp{{ number_format($dompet->price, 0, ',', ',') }} . {{ $orderData['dompet_size'] }} </p>
                        </div>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex items-center w-full rounded-full ring-1 ring-[#090917] px-[14px] gap-[10px] overflow-hidden transition-all duration-300 focus-within:ring-2 focus-within:ring-[#FFC700]">
                            ...
                            <input wire:mode="name" type="text" name="name" id="name" class="appearance-none outline-none w-full font-semibold placeholder:font-normal placeholder:text-[#878785] py-[14px]" placeholder="Type your complete name">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex items-center w-full rounded-full ring-1 ring-[#090917] px-[14px] gap-[10px] overflow-hidden transition-all duration-300 focus-within:ring-2 focus-within:ring-[#FFC700]">
                            ...
                            <input type="text" wire:mode="email" name="email" id="email" class="appearance-none outline-none w-full font-semibold placeholder:font-normal placeholder:text-[#878785] py-[14px]" placeholder="Type your email address">

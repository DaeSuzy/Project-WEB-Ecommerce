...
Route::get('/details/{dompet:slug}', [FrontController::class, 'details'])->name('front.details');

Route::post('/order/begin/{dompet:slug}', [OrderController::class, 'saveOrder'])->name('front.save_order');
